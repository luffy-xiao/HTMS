...
appServices.factory('Constants', ['$resource','$filter',
  function ($resource,$filter) {
      ...
      clients['rrStats'] = $resource('/api/RelocationRecordsStats/:id', { id: '@id' }, { 'update': { method: 'PUT' } })
      clients['rrStatsSize'] = $resource('/api/RelocationRecordsStatsSize/:id', { id: '@id' }, { 'update': { method: 'PUT' } })
